...
latex_documents = [
  ('index', 'kevells.tex', u'kevells Documentation',
   u'kevell', 'manual'),
]
...
man_pages = [
    ('index', 'kevells', u'kevells Documentation',
     [u'kevell'], 1)
]
...
texinfo_documents = [
  ('index', 'kevells', u'kevells Documentation',
   u'kevell', 'kevells', 'One line description of project.',
   'Miscellaneous'),
]
